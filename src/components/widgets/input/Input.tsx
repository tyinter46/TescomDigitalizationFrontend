...
return (
    <div className={
        `${getSize(size)}  ${className} flex items-center justify-between text-base bg-white placeholder:text-[#8692A6] border rounded-[6px] focus:border-primary`
    }>
        <input 
        {...props}
...
if (props.type === "tel"){
    return (
        ...
        return (
            <input className={`${getSize(size)} ${className} text-base bg-white placeholder:text-[#8692A6] border rounded-[6px] focus:border-primary`}
             {...props}
             />
        )
